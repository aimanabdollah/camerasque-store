Public Class frm_stafftable_a175054
    Private Sub frm_stafftable_a175054_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        grd_tablestaff.DataSource = mydatatable
    End Sub
